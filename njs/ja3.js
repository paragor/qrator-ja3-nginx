...
function ja3_qrator2salesforce(qrator_str) {
...
function ja3_njs(r, is_digest) {
    ...
    let ja3_long = ja3_qrator2salesforce(header)
    if (!is_digest) {
        return ja3_long
    }
...
export default {ja3_qrator2salesforce, ja3_njs_digest, ja3_njs_str}
...
// console.log(ja3_qrator2salesforce(_str))
